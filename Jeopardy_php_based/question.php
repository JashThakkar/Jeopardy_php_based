...
// We check if the current category/value matches our random spot
$isDD = false;
...
// NEW: Check if a wager has already been made
...
<!-- NEW: Daily Double Interface -->
<!-- If it IS a Daily Double AND we haven't wagered yet, show this form -->
<?php if ($isDD && $wager === 0): ?>
...
<?php else: ?>
    ...
    <form method="POST" action="submit_answer.php">
        ...
        <!-- NEW: Pass the wager along so we can use it for scoring later -->
